<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String get_number=request.getParameter("number");
    String get_chinese=request.getParameter("chinese");
    String get_math=request.getParameter("math");
...
String a = root.getElementsByTagName("name").item(i).getTextContent();
  ...
  {
    root.getElementsByTagName("name").item(i).setTextContent(get_name);
    root.getElementsByTagName("number").item(i).setTextContent(get_number);
    root.getElementsByTagName("chinese").item(i).setTextContent(get_chinese);
    root.getElementsByTagName("math").item(i).setTextContent(get_math);
